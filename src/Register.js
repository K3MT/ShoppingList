    ...
    return (
      ...
      <link href= "https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous"></link>
        ...
        <div class="imessage_security">
            ...
            <p class="from-me">For example, the question might be your dog's name</p>
            <p class="from-me">This information will be used in the event that you forget your password</p>
        ...
        <div class="imessage">
            ...
            <p class="from-me">It should also have at least one special character</p>
          </div>
      </div>
    )
}